...
const RE_DEF_METODO    = /^(PUBLIC|PRIVATE)?(VOID|BOOLEAN|INT|FLOAT|DOUBLE|STRING)NAMELPAREN.*(?=RPARENLBRACE)/;
//const RE_DEF_METODO    = /^(PUBLIC|PRIVATE)?(STATIC)(VOID|BOOLEAN|INT|FLOAT|DOUBLE|STRING)NAMELPAREN.*(?=RPARENLBRACE)/;
const RE_VAR_01        = /^(VOID|BOOLEAN|INT|FLOAT|DOUBLE|STRING|CHAR)NAME(?=SEMICOLON)/;
const RE_VAR_02        = /^(VOID|BOOLEAN|INT|FLOAT|DOUBLE|STRING|CHAR)NAME(EQ)(NUM|CADENA|BOOLEAN_LITERAL)(?=SEMICOLON)/;
